...
func RenameCategory(ctx context.Context, userID bson.ObjectID, oldName, newName string) error {
	...
	// Rename inside User.categories array using array filter or positional update.
	// Since user.categories is a simple string array, we can use positional operator '$'
